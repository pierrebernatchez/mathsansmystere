...
\begin{question}
  ...
  \begin{flushleft}
    ...
    \includegraphics[scale=0.5]{cylindre}\par
  \end{flushleft}
  \medskip

  (a) Exprimez $h$ en fonction de $r$.\hspace*{\fill} [2]\par
  \medskip
  \noindent Le métal pour la base et le couvercle de la boîte coûte 10 cents le $cm^3$ et le métal pour le côté incurvé coûte 8 cents le $cm^2$. Le coût total du métal, en cents, est de $C$.\par
  \medskip
...
\begin{question}
  \hspace*{\fill} [Note maximale: 15]\par
  \medskip
  \noindent La figure suivante donne la représentation graphique de $f(x) = a \times COS bx $, pour $ 0 \le x \le 4$.\par  
  \medskip
...
\begin{question}
  ...
  \medskip
  Trouvez $f^\prime(0)$.\hspace*{\fill} [6]\par
\end{question}

\bigskip
\begin{question}
  \hspace*{\fill} [Note maximale: TDB]\par
  \noindent TBD .. Il n'y a pas de 7 dans le document original\par
  \medskip
\end{question}
...
\begin{question}
  ...
  \begin{center}
    % \noindent La figure n'est pas a l'échelle\par
    \includegraphics[scale=0.4]{temp_down_parabola}\par
  \end{center}
  \medskip
...
au temps $t$ (en secondes), est donnée par $v = 240 + 20t -10t2$ , avec $0 \le t \le 6$\par
  \medskip
  (d)\par
  \medskip
...
\begin{question}
  ...
  \medskip
  \begin{center}
    \includegraphics[scale=0.3]{temp_polynom_minus4_to_3}\par
  \end{center}
  \medskip
